...
\name{\LARGE Parth}{\LARGE Sanepara}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}

% \address{YOUR ADDRESS}
\mobile{+91 9687119944}
\email{parthsanepara@gmail.com}
%\dateofbirth{January 1st, 1970}
\homepage{parthsanepara.github.io} 
\github{github.com/ParthSanepara}
\linkedin{linkedin.com/in/parthsanepara}
% \gitlab{gitlab-id}
