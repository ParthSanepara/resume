...
\section{Summary}
  \vspace{3pt}
  \textbf{\{Experienced Embedded Firmware Engineer with 5+ years of experience in designing, developing, and testing embedded systems and IoT solutions. Expertise in firmware development for \hl{wireless and wired technologies}, including \textbf{BLE}, \textbf{Wi-Fi}, \textbf{Ethernet}, and \textbf{Cellular IoT}. Proficient in \textbf{RTOS} programming (\textbf{Zephyr}, \textbf{FreeRTOS}), \textbf{low-power device development}, and \textbf{cloud integration} using \textbf{AWS IoT Core}. Strong background in \textbf{ARM-based MCUs}, \textbf{communication protocols} (\textbf{TCP/IP}, \textbf{MODBUS}, \textbf{MQTT}), and \textbf{embedded software debugging}. Skilled in \textbf{product prototyping}, \textbf{unit testing}, and \textbf{driver development} for smart devices, sensors, and IoT applications.\}}
  %----------- EDUCATION -----------
