...
\newcommand{\resumeCertificateBody}[4]{
    \vspace{-2pt}\item 
    % \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
      \textbf{#1} - \href{#2}{\small\underline{\color{blue} #3}} \hfill \textit{\small #4}
    % \end{tabular*}
...
\section{Summary}
  \vspace{3pt}
  {Experienced \textbf{Embedded Firmware Engineer} with 5+ years of experience in designing, developing, and testing embedded systems and IoT solutions. Expertise in firmware development for wireless and wired technologies, including \textbf{BLE, Wi-Fi, Ethernet, and Cellular IoT.} Proficient in RTOS programming (\textbf{Zephyr, FreeRTOS}), low-power device development, and cloud integration using \textbf{AWS IoT Core}. Strong background in ARM-based MCUs, communication protocols (TCP/IP, MODBUS, MQTT), and embedded software debugging. Skilled in product prototyping, unit testing, and driver development for smart devices, sensors, and IoT applications.}
  %----------- EDUCATION -----------
...
\section{Certificates}
  \resumeSubHeadingListStart
    ...
    \resumeCertificateBody{Certification in Software architecture for the Internet of Things}{https://www.coursera.org/}{Coursera}{} 
    \resumeCertificateBody{Certification in Internet of things}{https://online.stanford.edu/}{Standford University Online University}{} 
    \resumeCertificateBody{Certification in nRF Connect SDK Fundamentals}{https://academy.nordicsemi.com/check-certificate/7019A8670F377B1-7019A866AD01C7E-11EFA0106D7401_39/}{Nordic Semiconductor}{July 2024}
    \resumeCertificateBody{Certification in nRF Connect SDK Intermediate}{https://academy.nordicsemi.com/check-certificate/7019A867726D612-7019A8676DADA25-11EFA0106D7401_39/}{Nordic Semiconductor}{September 2024}
    \resumeCertificateBody{Certification in Bluetooth Low Energy Fundamentals}{https://academy.nordicsemi.com/check-certificate/7019A86769CBFAC-7019A866B1CDFA9-11EFA0106D7401_39/}{Nordic Semiconductor}{September 2024}
    \resumeCertificateBody{Certification in Wi-Fi Fundamentals}{https://academy.nordicsemi.com/check-certificate/7019A86770801E5-7019A8676BC0781-11EFA0106D7401_39/}{Nordic Semiconductor}{September 2024}
    \resumeCertificateBody{Certification in Cellular IoT Fundamentals}{https://academy.nordicsemi.com/check-certificate/7019A8670F39C60-7019A866B1D2DCD-11EFA0106D7401_39/}{Nordic Semiconductor}{Octomber 2024}
\resumeSubHeadingListEnd
